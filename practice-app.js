...
function openSubject(id) {
  location.href = "practice-admin.html";
}
...
function createExam() {
  ...
  const link =
    `${location.origin}${location.pathname.replace("practice-admin.html", "")}practice-exam.html?id=${exam.id}`;
          ...
          <tr>
            ...
            <td>
              <a class="btn btn--primary"
                href="practice-exam.html?id=${exam.id}">
                Open
              </a>
            </td>
          </tr>
